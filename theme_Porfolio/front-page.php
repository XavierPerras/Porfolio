...
<section class="projets">
    <div class="wrapper">
        ...
        <div class="projetsContent">
            <img data-scrolly='fromLeft' src="<?php bloginfo('template_url'); ?>/dist/assets/images/laFusee/hero.jpg" alt="Image de projet de la fusée" />
            <div data-scrolly='fromRight' class="projetsTxt">
                <h3>La fusée</h3>
                <h2>Blender, 3D, montage sonore</h2>
                <p>Décollage d’une fusée dans l’espace. Elle va entrer dans l’hyper vitesse.</p>
                <a class="bouton" href="https://xperras.dectim.ca/la-fusee/">Voir le projet</a>
            </div>
        </div>
        <div class="projetsContent">
            <img data-scrolly='fromLeft' src="<?php bloginfo('template_url'); ?>/dist/assets/images/imgTimTool.png" alt="Image du projet TimTools" />
            <div data-scrolly='fromRight' class="projetsTxt">
                <h3>TimTools</h3>
        ...
        <a class="bouton ttsproj" href="https://xperras.dectim.ca/projets/">Voir les projets</a>
    </div>
</section>
